              ...
              <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                <div className="flex items-start gap-6 text-sm">
                  ...
                  <div>
                    ...
                    <p className='mt-2 '>Date : <span className='tex-gray-400'>{new Date(item.date).toDateString()}</span></p>
                    <p className='mt-2 '>Payment : <span className='tex-gray-400'>{item.paymentMethod}</span></p>
                  </div>
                </div>
